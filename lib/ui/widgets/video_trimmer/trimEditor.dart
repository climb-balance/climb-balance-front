...
import 'package:climb_balance/ui/widgets/video_trimmer/thumnailViewer.dart';
import 'package:climb_balance/ui/widgets/video_trimmer/trimEditorPainter.dart';
...
class TrimEditor extends StatefulWidget {
  ...
  const TrimEditor({
    ...
    this.circlePaintColor = Colors.black,
    this.borderPaintColor = Colors.black,
    this.scrubberPaintColor = Colors.black,
