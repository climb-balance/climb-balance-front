...
class TagsNotifier extends StateNotifier<TagsSelection> {
  ...
  void loadTagsData() {
    state =
        TagsSelection(locations: locationData, difficulties: difficultyData);
  }
}

final tagsProvider = StateNotifierProvider<TagsNotifier, TagsSelection>((ref) {
  TagsNotifier notifier = TagsNotifier(ref: ref);
  notifier.loadTagsData();
  return notifier;
});
